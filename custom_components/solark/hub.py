...
if hasattr(pymodbus, "__version__") and (
    ((pymodbus.__version__[0] == "3") and (pymodbus.__version__[2] <= "1"))
    or (pymodbus.__version__[0] <= "2")
):
    from pymodbus.register_read_message import ReadHoldingRegistersResponse

    prior347 = True
elif hasattr(pymodbus, "__version__") and (
    (pymodbus.__version__[0] == "3") and (pymodbus.__version__[2] < "8")
):
